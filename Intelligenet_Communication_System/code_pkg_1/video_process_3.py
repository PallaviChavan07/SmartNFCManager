...
class DlibProcess():
    ...
    def get_lanmark_data(self):
        ...
        self.land_mark_dict[LFT_EYE_TOP1] = (land_mark_obj.part(LandMarkLoc.lt_eye_top_1.value).x, land_mark_obj.part(LandMarkLoc.lt_eye_top_1.value).y)
        
        #Left Eye Btm 1 x, y coordinate
        self.land_mark_dict[LFT_EYE_BTM1] = (land_mark_obj.part(LandMarkLoc.lt_eye_btm_1.value).x, land_mark_obj.part(LandMarkLoc.lt_eye_btm_1.value).y)
        
        #Left Eye Top 2 x, y coordinate
        self.land_mark_dict[LFT_EYE_TOP2] = (land_mark_obj.part(LandMarkLoc.lt_eye_top_2.value).x, land_mark_obj.part(LandMarkLoc.lt_eye_top_2.value).y)
        #Left Eye Btm 2 x, y coordinate
        self.land_mark_dict[LFT_EYE_BTM2] = (land_mark_obj.part(LandMarkLoc.lt_eye_btm_2.value).x, land_mark_obj.part(LandMarkLoc.lt_eye_btm_2.value).y)
        
        #Right Eye Top 1 x, y coordinate
        self.land_mark_dict[RT_EYE_TOP1] = (land_mark_obj.part(LandMarkLoc.rt_eye_top_1.value).x, land_mark_obj.part(LandMarkLoc.rt_eye_top_1.value).y)
        #Right Eye Btm 1 x, y coordinate
        self.land_mark_dict[RT_EYE_BTM1] = (land_mark_obj.part(LandMarkLoc.rt_eye_btm_1.value).x, land_mark_obj.part(LandMarkLoc.rt_eye_btm_1.value).y)
        
        #Right Eye Top 2 x, y coordinate
        self.land_mark_dict[RT_EYE_TOP2] = (land_mark_obj.part(LandMarkLoc.rt_eye_top_2.value).x, land_mark_obj.part(LandMarkLoc.rt_eye_top_2.value).y)
        #Right Eye Btm 2 x, y coordinate
        self.land_mark_dict[RT_EYE_BTM2] = (land_mark_obj.part(LandMarkLoc.rt_eye_btm_2.value).x, land_mark_obj.part(LandMarkLoc.rt_eye_btm_2.value).y)
        
        #Left Eye start corner x, y coordinate
        self.land_mark_dict[LFT_EYE_ST_CNR] = (land_mark_obj.part(LandMarkLoc.lt_eye_st_crn.value).x, land_mark_obj.part(LandMarkLoc.lt_eye_st_crn.value).y)
        
        #Left Eye end corner x, y coordinate
        self.land_mark_dict[LFT_EYE_END_CNR] = (land_mark_obj.part(LandMarkLoc.lt_eye_end_crn.value).x, land_mark_obj.part(LandMarkLoc.lt_eye_end_crn.value).y)
        
        #Right Eye start corner x, y coordinate
        self.land_mark_dict[RT_EYE_ST_CNR] = (land_mark_obj.part(LandMarkLoc.rt_eye_st_crn.value).x, land_mark_obj.part(LandMarkLoc.rt_eye_st_crn.value).y)
        
        #Right Eye end corner x, y coordinate
        self.land_mark_dict[RT_EYE_END_CNR] = (land_mark_obj.part(LandMarkLoc.rt_eye_end_crn.value).x, land_mark_obj.part(LandMarkLoc.rt_eye_end_crn.value).y)
        
        lt_h1 = land_mark_obj.part(LandMarkLoc.lt_eye_btm_1.value).y - land_mark_obj.part(LandMarkLoc.lt_eye_top_1.value).y
        lt_h2 = land_mark_obj.part(LandMarkLoc.lt_eye_btm_2.value).y - land_mark_obj.part(LandMarkLoc.lt_eye_top_2.value).y
        ...
        #EYE_STATE_OPEN self.blink_count, self.eye_state
    ...
    def show_image(self):
        ...
        if len(self.land_mark_dict) == 0:
            disp_img = cv2.line(disp_img, (disp_img.shape[1] - 50,int(disp_img.shape[0]/2)), (disp_img.shape[1] - 50,int(disp_img.shape[0]/2)), (0, 0, 255), 40)
        else:
            disp_img = cv2.line(disp_img, (disp_img.shape[1] - 50,int(disp_img.shape[0]/2)), (disp_img.shape[1] - 50,int(disp_img.shape[0]/2)), (0, 255, 0), 40)
        
        cv2.putText(disp_img, "Blink Count {}".format(self.blink_count), (50, 30), cv2.FONT_HERSHEY_SIMPLEX, .5, (255,0,0), 1, cv2.LINE_AA)
...
def main():
    ...
    print('Press "e" to terminate the application')
    
    #create an object of Video Process
    land_mark_process = DlibProcess()
    
    #start video capture
    land_mark_process.start_process(True)
